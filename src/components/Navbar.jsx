      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        ...
        <div class="hidden w-full md:block md:w-auto " id="navbar-default">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border md:p-2 md:px-4 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="/home" class="block py-2 px-3 text-white  rounded hover:bg-transparent  md:p-0 dark:text-white md:hover:text-blue-700  " aria-current="page">Home</a>
            </li>
            <li>
            ...
            <li>
              <a href="/register" class="border border-2 border-white hover:bg-white hover:text-black font-bold p-2 rounded rounded-lg ">Join Now</a>
            </li>
          </ul>
        </div>
      </div>
