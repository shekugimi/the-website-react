      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-0">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <h2 className="font-heading mb-4 font-bold tracking-tight text-gray-900 text-white text-3xl sm:text-5xl">
              Get in Touch
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 text-slate-400">
          ...
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              <ul className="mb-6 text-start p-10 md:mb-0">
                <p className="mt-0 mb-12 ml-4 text-lg text-gray-600 text-slate-400">
                ...
                <div className="mb-0">
                  ...
                  <div className="mx-0 mb-1 sm:mb-4">
                    ...
                    <textarea
                      ...
                      className=" w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md text-gray-300 sm:mb-0"
                    ></textarea>
                  </div>
                </div>
                <center>
