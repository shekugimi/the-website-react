...
const Partners = () => {
  ...
  return (
    <section className="our_partnered_companies md:py-16 mg:h-screen">
      <div className="container mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-center">Our Partnered Companies</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {companyLogos.map((logo, index) => (
            <div
              key={index}
              className="company_logo bg-gray-600 p-4 rounded-lg shadow-md transform rotate-[10deg] hover:rotate-0 transition-transform duration-300 ease-in-out"
              style={{
